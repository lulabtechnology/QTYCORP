...
export const companyPage = {
  ...
  missionSubtitle: 'Suministro · Reparación · Protección industrial',
  mission:
    'Acompañamos a nuestros clientes en suministro, reparación y protección industrial con respaldo técnico, tecnologías confiables y una atención enfocada en generar valor real en cada aplicación.',
  visionTitle: 'Ser un referente regional de alto desempeño',
  visionSubtitle: 'Excelencia · Innovación · Sostenibilidad',
  vision:
    'Buscamos consolidarnos en Latinoamérica como un aliado confiable en soluciones industriales, reconocido por su excelencia técnica, innovación y compromiso con la seguridad y sostenibilidad operativa.',
  values: [
    {
      title: 'Compromiso con el cliente',
      description: 'Ofrecemos un servicio cercano, personalizado y orientado al éxito de cada cliente.',
      icon: Handshake,
    },
    {
      title: 'Excelencia técnica',
      description: 'Garantizamos un alto nivel de conocimiento y profesionalismo en cada solución.',
      icon: CircleGauge,
    },
    {
      title: 'Integridad',
      description: 'Actuamos con honestidad, transparencia y ética en todo momento.',
      icon: ShieldCheck,
    },
    {
      title: 'Innovación continua',
      description: 'Buscamos soluciones modernas y efectivas para optimizar tecnologías y procesos.',
      icon: Lightbulb,
    },
    {
      title: 'Sostenibilidad',
      description: 'Incorporamos prácticas responsables que preservan los recursos y reducen el impacto ambiental.',
      icon: Leaf,
    },
    {
      title: 'Trabajo en equipo',
      description: 'Fomentamos una cultura de apoyo y colaboración conjunta para alcanzar resultados.',
      icon: Users,
    },
  ],
  workSteps: [
