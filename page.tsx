...
const valueSupportItems = [
  { title: 'Evaluación más clara de requerimientos', icon: ShieldCheck },
  ...
  { title: 'Respuesta técnica cercana y consultiva', icon: Users },
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[var(--qts-navy)] py-24 text-white">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(8,15,29,0.84)_0%,rgba(10,18,34,0.78)_34%,rgba(12,22,39,0.4)_66%,rgba(15,24,43,0.24)_100%)]" />
            ...
            <Reveal>
              <article className="overflow-hidden rounded-[34px] border border-[var(--qts-line)] bg-white shadow-[0_26px_84px_rgba(9,17,31,0.08)]">
                ...
                <div className="relative mt-8 aspect-[16/8] overflow-hidden border-y border-[var(--qts-line)]">
                  <Image src={assets.services.process} alt="Equipo técnico evaluando una aplicación industrial" fill className="object-cover" />
                </div>
