        ...
        <div className="grid gap-10 lg:grid-cols-[1.06fr_0.94fr] lg:items-center">
                ...
                {institutionalPillars.map((item, index) => {
                  ...
                  return (
                    <Reveal key={item.title} delay={index * 0.08}>
                      <div className="flex h-full flex-col rounded-[24px] border border-[var(--qts-line)] bg-[var(--qts-ink-soft)] p-5">
          ...
          <Reveal delay={0.1}>
            <div className="relative min-h-[520px] overflow-hidden rounded-[34px] border border-[var(--qts-line)] shadow-[0_20px_70px_rgba(9,17,31,0.12)]">
              <Image src={assets.home.trust} alt="Cobertura regional de QTS" fill className="object-cover" />
              <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(15,26,46,0.12)_0%,rgba(15,26,46,0.42)_48%,rgba(15,26,46,0.9)_100%)]" />
              <div className="absolute inset-x-0 bottom-0 p-8 text-white">
                <h3 className="max-w-lg text-3xl font-semibold tracking-[-0.03em] sm:text-[2.35rem] sm:leading-[1.08]">Tecnología internacional, criterio técnico y acompañamiento cercano</h3>
              </div>
            </div>
          </Reveal>
        </div>
